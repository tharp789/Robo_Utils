...
if __name__ == '__main__':
    ...
    input_folder = '/home/tyler/Documents/SplaTAM/data/TartanAir/depth_estimation/'
    output_folder = '/home/tyler/Documents/SplaTAM/data/TartanAir/depth_est_colormap/'
    # convert_depth_folder_to_colormap(input_folder, output_folder, show_img=False)
    # convert_folder_to_depth(input_folder, output_folder)
    convert_folder_to_depth_images(input_folder, output_folder, max_dist=30.0)
